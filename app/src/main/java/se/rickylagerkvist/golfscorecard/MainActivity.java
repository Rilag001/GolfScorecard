package se.rickylagerkvist.golfscorecard;
...
public class MainActivity extends ListActivity {
    ...
    private static final String PREFS_FILE = "se.rickylagerkvist.golfscorecard.preferences";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_clear_strokes) {
            ...
            mListAdapter.notifyDataSetChanged(); // Tells Android that the data changed
